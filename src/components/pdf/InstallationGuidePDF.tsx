...
export const InstallationGuidePDF: React.FC<InstallationGuidePDFProps> = ({ 
  ...
  return (
    <Document>
      {/* Page 1: Project Information and Specifications */}
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.footer}>
          <Text>
            Generated by LED Wall Configurator | Created: {createdAt} | Page 1 of 2
          </Text>
        </View>
      </Page>

      {/* Page 2: Installation Layout and Guidelines */}
      <Page size="A4" style={styles.page}>
        {/* Header */}
        <Text style={styles.title}>Installation Layout & Guidelines</Text>
        <Text style={styles.subtitle}>{displayConfig.modelName} Configuration</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoRow}>
            ...
            <Text style={styles.value}>
              {wallConfig.setup === 'indoor' ? 'Indoor use only' : 'Outdoor rated installation'}
            </Text>
          </View>
          <View style={styles.infoRow}>
            <Text style={styles.label}>Operating Temperature:</Text>
            <Text style={styles.value}>
              {wallConfig.setup === 'indoor' ? '0°C to 40°C (32°F to 104°F)' : '-20°C to 50°C (-4°F to 122°F)'}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.footer}>
          <Text>
            Generated by LED Wall Configurator | Created: {createdAt} | Page 2 of 2
          </Text>
        </View>
      </Page>
    </Document>
